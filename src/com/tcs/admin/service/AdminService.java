...
//		 }
 ...
 @POST
	...
	public Response delete_Vendor(String id) 
	{
		/* sid */
	
		try 
		{
			ArrayList<String> idList = new Genson().deserialize(id, new GenericType<ArrayList<String>>() {
			});
			//System.out.println(idList);
			ArrayList<String> cannotDelVendor = admindao.deleteVendor(idList);
			response = Response.ok().entity(cannotDelVendor).build();
